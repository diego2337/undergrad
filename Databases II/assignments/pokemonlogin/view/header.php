    ...
    <div class="container">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="?action=listarTreinador">Buscar</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a href="?action=listarAtaque">Buscar</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="?action=insertPokermart">Inserir</a></li>
                            <li><a href="?action=listarPokermart">Listar</a></li>
		...
		if(isset($_SESSION['User']))
		{
                echo '<li class="dropdown">
                        <a href="?action=showPainel">Meu Painel</a>
                    </li>
                    <li class="dropdown">
                        <a href="?action=logoff">Sair</a>
                    </li>'
                    ;
                }else
                echo '<li class="dropdown">
                        <a href="?action=logoff">Login</a>
                    </li>';
	    ?>
                </ul>
