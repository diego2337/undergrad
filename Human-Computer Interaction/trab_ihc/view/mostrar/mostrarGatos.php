...
<div class="margin mdl-grid mdl-shadow--2dp mdl-color--purple">
    <img class="threehundredpx" src="misc/images/black_cat.jpg" alt="Imagem do animal"></img>
...
<br>
<div class="margin mdl-grid mdl-shadow--2dp mdl-color--purple">
    <img class="threehundredpx" src="misc/images/small_cat.jpg" alt="Imagem do animal"></img>
    <h6 class="margin v-align">
        Espécie: Gato
        <br>
        Nome: Jill
...
<br>
<div class="margin mdl-grid mdl-shadow--2dp mdl-color--purple">
    <img class="threehundredpx" src="misc/images/persian_cat.jpg" alt="Imagem do animal"></img>
    <h6 class="margin v-align">
        Espécie: Gato
        <br>
        Nome: Fofucho
