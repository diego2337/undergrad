...
<div class="margin mdl-grid mdl-shadow--2dp mdl-color--light-green">
    <img class="threehundredpx" src="misc/images/growlithe.png" alt="Imagem do animal"></img>
...
<br>
<div class="margin mdl-grid mdl-shadow--2dp mdl-color--light-green">
    <img class="threehundredpx" src="misc/images/arcanine.png" alt="Imagem do animal"></img>
    <h6 class="margin v-align">
        Espécie: Cachorro
        <br>
        Nome: Leônidas
...
<br>
<div class="margin mdl-grid mdl-shadow--2dp mdl-color--light-green">
    <img class="threehundredpx" src="misc/images/boxer.jpg" alt="Imagem do animal"></img>
    <h6 class="margin v-align">
        Espécie: Cachorro
        <br>
        Nome: Tigrão
